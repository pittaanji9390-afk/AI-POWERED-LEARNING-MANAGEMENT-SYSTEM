...
/**
 * Enterprise Production Pipeline: SkillMasteryTreePipeline (Part 6)
 * Subsystem: personalization
 * Purpose: Bayesian knowledge tracing & adaptive recommendations
 */
@Service
public class SkillMasteryTreePipelinePart6 {

    private static final Logger log = LoggerFactory.getLogger(SkillMasteryTreePipelinePart6.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "personalization", "part", 6, "thread", Thread.currentThread().getName())
        );
