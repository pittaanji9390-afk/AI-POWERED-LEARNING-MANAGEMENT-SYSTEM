...
/**
 * Enterprise Production Pipeline: MultiTenantProvisioningPipeline (Part 11)
 * Subsystem: organization
 * Purpose: Automated workspace provisioning & domain DNS router
 */
@Service
public class MultiTenantProvisioningPipelinePart11 {

    private static final Logger log = LoggerFactory.getLogger(MultiTenantProvisioningPipelinePart11.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "organization", "part", 11, "thread", Thread.currentThread().getName())
        );
