...
/**
 * Enterprise Production Pipeline: DiscussionThreadModerator (Part 7)
 * Subsystem: collaboration
 * Purpose: Automated NLP profanity & spam detection engine
 */
@Service
public class DiscussionThreadModeratorPart7 {

    private static final Logger log = LoggerFactory.getLogger(DiscussionThreadModeratorPart7.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "collaboration", "part", 7, "thread", Thread.currentThread().getName())
        );
