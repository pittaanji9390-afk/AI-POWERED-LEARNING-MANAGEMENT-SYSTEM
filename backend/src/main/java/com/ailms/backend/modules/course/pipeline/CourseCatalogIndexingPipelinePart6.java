...
/**
 * Enterprise Production Pipeline: CourseCatalogIndexingPipeline (Part 6)
 * Subsystem: course
 * Purpose: Elasticsearch & Vector sync pipeline for course metadata
 */
@Service
public class CourseCatalogIndexingPipelinePart6 {

    private static final Logger log = LoggerFactory.getLogger(CourseCatalogIndexingPipelinePart6.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "course", "part", 6, "thread", Thread.currentThread().getName())
        );
