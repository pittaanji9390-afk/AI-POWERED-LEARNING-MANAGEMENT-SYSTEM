...
/**
 * Enterprise Production Pipeline: CourseCatalogIndexingPipeline (Part 1)
 * Subsystem: course
 * Purpose: Elasticsearch & Vector sync pipeline for course metadata
 */
@Service
public class CourseCatalogIndexingPipelinePart1 {

    private static final Logger log = LoggerFactory.getLogger(CourseCatalogIndexingPipelinePart1.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "course", "part", 1, "thread", Thread.currentThread().getName())
        );
