...
/**
 * Enterprise Production Pipeline: SubscriptionLifecycleEngine (Part 6)
 * Subsystem: billing
 * Purpose: Multi-tenant recurring invoice & dunning orchestrator
 */
@Service
public class SubscriptionLifecycleEnginePart6 {

    private static final Logger log = LoggerFactory.getLogger(SubscriptionLifecycleEnginePart6.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "billing", "part", 6, "thread", Thread.currentThread().getName())
        );
