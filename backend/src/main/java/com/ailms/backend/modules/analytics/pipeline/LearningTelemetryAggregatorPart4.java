...
/**
 * Enterprise Production Pipeline: LearningTelemetryAggregator (Part 4)
 * Subsystem: analytics
 * Purpose: Time-series event processor & engagement analytics
 */
@Service
public class LearningTelemetryAggregatorPart4 {

    private static final Logger log = LoggerFactory.getLogger(LearningTelemetryAggregatorPart4.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "analytics", "part", 4, "thread", Thread.currentThread().getName())
        );
