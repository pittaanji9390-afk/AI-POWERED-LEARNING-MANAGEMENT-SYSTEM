...
/**
 * Enterprise Production Pipeline: SocraticPromptOrchestrator (Part 12)
 * Subsystem: ai
 * Purpose: Boundary sandboxed RAG retrieval & anti-injection verifier
 */
@Service
public class SocraticPromptOrchestratorPart12 {

    private static final Logger log = LoggerFactory.getLogger(SocraticPromptOrchestratorPart12.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "ai", "part", 12, "thread", Thread.currentThread().getName())
        );
