...
/**
 * Enterprise Production Pipeline: ExamSessionOrchestrationPipeline (Part 1)
 * Subsystem: assessment
 * Purpose: Timed examination heartbeat & plagiarism prevention engine
 */
@Service
public class ExamSessionOrchestrationPipelinePart1 {

    private static final Logger log = LoggerFactory.getLogger(ExamSessionOrchestrationPipelinePart1.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "assessment", "part", 1, "thread", Thread.currentThread().getName())
        );
