...
/**
 * Enterprise Production Pipeline: SubscriptionLifecycleEngine (Part 2)
 * Subsystem: billing
 * Purpose: Multi-tenant recurring invoice & dunning orchestrator
 */
@Service
public class SubscriptionLifecycleEnginePart2 {

    private static final Logger log = LoggerFactory.getLogger(SubscriptionLifecycleEnginePart2.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "billing", "part", 2, "thread", Thread.currentThread().getName())
        );
