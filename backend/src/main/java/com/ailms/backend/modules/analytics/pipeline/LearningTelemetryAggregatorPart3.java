...
/**
 * Enterprise Production Pipeline: LearningTelemetryAggregator (Part 3)
 * Subsystem: analytics
 * Purpose: Time-series event processor & engagement analytics
 */
@Service
public class LearningTelemetryAggregatorPart3 {

    private static final Logger log = LoggerFactory.getLogger(LearningTelemetryAggregatorPart3.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "analytics", "part", 3, "thread", Thread.currentThread().getName())
        );
