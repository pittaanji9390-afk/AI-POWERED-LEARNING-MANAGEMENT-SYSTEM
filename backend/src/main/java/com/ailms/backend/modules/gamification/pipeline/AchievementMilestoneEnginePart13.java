...
/**
 * Enterprise Production Pipeline: AchievementMilestoneEngine (Part 13)
 * Subsystem: gamification
 * Purpose: XP calculation, badge unlock triggers, and leaderboard rankings
 */
@Service
public class AchievementMilestoneEnginePart13 {

    private static final Logger log = LoggerFactory.getLogger(AchievementMilestoneEnginePart13.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "gamification", "part", 13, "thread", Thread.currentThread().getName())
        );
