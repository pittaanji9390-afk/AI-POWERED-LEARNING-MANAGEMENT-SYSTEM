...
/**
 * Enterprise Production Pipeline: CryptographicPdfSigner (Part 8)
 * Subsystem: certificate
 * Purpose: SHA-256 digital signature issuer & public QR verification portal
 */
@Service
public class CryptographicPdfSignerPart8 {

    private static final Logger log = LoggerFactory.getLogger(CryptographicPdfSignerPart8.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "certificate", "part", 8, "thread", Thread.currentThread().getName())
        );
