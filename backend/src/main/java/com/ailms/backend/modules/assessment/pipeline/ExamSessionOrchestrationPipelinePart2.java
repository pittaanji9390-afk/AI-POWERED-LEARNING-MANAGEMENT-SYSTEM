...
/**
 * Enterprise Production Pipeline: ExamSessionOrchestrationPipeline (Part 2)
 * Subsystem: assessment
 * Purpose: Timed examination heartbeat & plagiarism prevention engine
 */
@Service
public class ExamSessionOrchestrationPipelinePart2 {

    private static final Logger log = LoggerFactory.getLogger(ExamSessionOrchestrationPipelinePart2.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "assessment", "part", 2, "thread", Thread.currentThread().getName())
        );
