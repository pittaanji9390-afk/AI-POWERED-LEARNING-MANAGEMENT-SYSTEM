...
/**
 * Enterprise Production Pipeline: Lti1p3CanvasBlackboardBridge (Part 3)
 * Subsystem: integration
 * Purpose: LTI 1.3 Advantage interoperability & grade sync provider
 */
@Service
public class Lti1p3CanvasBlackboardBridgePart3 {

    private static final Logger log = LoggerFactory.getLogger(Lti1p3CanvasBlackboardBridgePart3.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "integration", "part", 3, "thread", Thread.currentThread().getName())
        );
