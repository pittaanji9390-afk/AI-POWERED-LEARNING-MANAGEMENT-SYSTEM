...
/**
 * Enterprise Production Pipeline: MultiTenantProvisioningPipeline (Part 10)
 * Subsystem: organization
 * Purpose: Automated workspace provisioning & domain DNS router
 */
@Service
public class MultiTenantProvisioningPipelinePart10 {

    private static final Logger log = LoggerFactory.getLogger(MultiTenantProvisioningPipelinePart10.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "organization", "part", 10, "thread", Thread.currentThread().getName())
        );
