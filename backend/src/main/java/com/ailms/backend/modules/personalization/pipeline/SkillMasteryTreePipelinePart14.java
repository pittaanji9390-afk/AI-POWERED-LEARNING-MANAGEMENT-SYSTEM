...
/**
 * Enterprise Production Pipeline: SkillMasteryTreePipeline (Part 14)
 * Subsystem: personalization
 * Purpose: Bayesian knowledge tracing & adaptive recommendations
 */
@Service
public class SkillMasteryTreePipelinePart14 {

    private static final Logger log = LoggerFactory.getLogger(SkillMasteryTreePipelinePart14.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "personalization", "part", 14, "thread", Thread.currentThread().getName())
        );
