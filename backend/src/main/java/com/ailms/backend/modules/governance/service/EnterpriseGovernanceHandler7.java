 ...
 */
@Service
public class EnterpriseGovernanceHandler7 {

    private static final Logger log = LoggerFactory.getLogger(EnterpriseGovernanceHandler7.class);
    ...
    public OperationResult processTask(String taskKey, UUID tenantId, Map<String, Object> parameters) {
        ...
        return new OperationResult(
                ...
                opId,
                Instant.now(),
                Map.of("tenantId", tenantId != null ? tenantId.toString() : "GLOBAL", "module", "governance", "index", 7)
        );
    }
