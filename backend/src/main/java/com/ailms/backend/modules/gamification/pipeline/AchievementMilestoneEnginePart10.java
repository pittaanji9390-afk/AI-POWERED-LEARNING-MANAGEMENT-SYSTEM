...
/**
 * Enterprise Production Pipeline: AchievementMilestoneEngine (Part 10)
 * Subsystem: gamification
 * Purpose: XP calculation, badge unlock triggers, and leaderboard rankings
 */
@Service
public class AchievementMilestoneEnginePart10 {

    private static final Logger log = LoggerFactory.getLogger(AchievementMilestoneEnginePart10.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "gamification", "part", 10, "thread", Thread.currentThread().getName())
        );
