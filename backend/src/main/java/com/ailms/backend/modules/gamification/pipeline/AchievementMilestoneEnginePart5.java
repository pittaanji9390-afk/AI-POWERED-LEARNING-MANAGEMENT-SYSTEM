...
/**
 * Enterprise Production Pipeline: AchievementMilestoneEngine (Part 5)
 * Subsystem: gamification
 * Purpose: XP calculation, badge unlock triggers, and leaderboard rankings
 */
@Service
public class AchievementMilestoneEnginePart5 {

    private static final Logger log = LoggerFactory.getLogger(AchievementMilestoneEnginePart5.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "gamification", "part", 5, "thread", Thread.currentThread().getName())
        );
