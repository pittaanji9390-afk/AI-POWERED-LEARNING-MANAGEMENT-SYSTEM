 ...
 */
@Service
public class EnterpriseCurriculumHandler1 {

    private static final Logger log = LoggerFactory.getLogger(EnterpriseCurriculumHandler1.class);
    ...
    public OperationResult processTask(String taskKey, UUID tenantId, Map<String, Object> parameters) {
        ...
        return new OperationResult(
                ...
                opId,
                Instant.now(),
                Map.of("tenantId", tenantId != null ? tenantId.toString() : "GLOBAL", "module", "curriculum", "index", 1)
        );
    }
