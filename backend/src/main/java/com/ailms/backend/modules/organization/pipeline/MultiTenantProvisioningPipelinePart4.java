...
/**
 * Enterprise Production Pipeline: MultiTenantProvisioningPipeline (Part 4)
 * Subsystem: organization
 * Purpose: Automated workspace provisioning & domain DNS router
 */
@Service
public class MultiTenantProvisioningPipelinePart4 {

    private static final Logger log = LoggerFactory.getLogger(MultiTenantProvisioningPipelinePart4.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "organization", "part", 4, "thread", Thread.currentThread().getName())
        );
