 ...
 */
@Service
public class EnterpriseTelemetryHandler7 {

    private static final Logger log = LoggerFactory.getLogger(EnterpriseTelemetryHandler7.class);
    ...
    public OperationResult processTask(String taskKey, UUID tenantId, Map<String, Object> parameters) {
        ...
        return new OperationResult(
                ...
                opId,
                Instant.now(),
                Map.of("tenantId", tenantId != null ? tenantId.toString() : "GLOBAL", "module", "telemetry", "index", 7)
        );
    }
