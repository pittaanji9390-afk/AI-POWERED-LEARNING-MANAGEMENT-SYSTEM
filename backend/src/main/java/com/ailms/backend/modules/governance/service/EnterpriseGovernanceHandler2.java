 ...
 */
@Service
public class EnterpriseGovernanceHandler2 {

    private static final Logger log = LoggerFactory.getLogger(EnterpriseGovernanceHandler2.class);
    ...
    public OperationResult processTask(String taskKey, UUID tenantId, Map<String, Object> parameters) {
        ...
        return new OperationResult(
                ...
                opId,
                Instant.now(),
                Map.of("tenantId", tenantId != null ? tenantId.toString() : "GLOBAL", "module", "governance", "index", 2)
        );
    }
