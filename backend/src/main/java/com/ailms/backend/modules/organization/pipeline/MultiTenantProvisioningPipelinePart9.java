...
/**
 * Enterprise Production Pipeline: MultiTenantProvisioningPipeline (Part 9)
 * Subsystem: organization
 * Purpose: Automated workspace provisioning & domain DNS router
 */
@Service
public class MultiTenantProvisioningPipelinePart9 {

    private static final Logger log = LoggerFactory.getLogger(MultiTenantProvisioningPipelinePart9.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "organization", "part", 9, "thread", Thread.currentThread().getName())
        );
