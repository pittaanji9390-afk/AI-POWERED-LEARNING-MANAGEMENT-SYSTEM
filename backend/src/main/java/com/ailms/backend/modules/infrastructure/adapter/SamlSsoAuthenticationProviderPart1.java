...
/**
 * Enterprise Production Adapter: SamlSsoAuthenticationProvider (Part 1)
 * Purpose: Enterprise SAML 2.0 and OIDC federated identity broker
 */
@Component
public class SamlSsoAuthenticationProviderPart1 {

    private static final Logger log = LoggerFactory.getLogger(SamlSsoAuthenticationProviderPart1.class);
    ...
    public AdapterResponse processRequest(String requestId, UUID organizationId, Map<String, Object> data) {
        log.info("Adapter SamlSsoAuthenticationProviderPart1 handling request [id={}, org={}]", requestId, organizationId);
