...
/**
 * Enterprise Production Pipeline: DiscussionThreadModerator (Part 9)
 * Subsystem: collaboration
 * Purpose: Automated NLP profanity & spam detection engine
 */
@Service
public class DiscussionThreadModeratorPart9 {

    private static final Logger log = LoggerFactory.getLogger(DiscussionThreadModeratorPart9.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "collaboration", "part", 9, "thread", Thread.currentThread().getName())
        );
