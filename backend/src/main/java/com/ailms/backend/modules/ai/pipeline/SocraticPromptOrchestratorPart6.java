...
/**
 * Enterprise Production Pipeline: SocraticPromptOrchestrator (Part 6)
 * Subsystem: ai
 * Purpose: Boundary sandboxed RAG retrieval & anti-injection verifier
 */
@Service
public class SocraticPromptOrchestratorPart6 {

    private static final Logger log = LoggerFactory.getLogger(SocraticPromptOrchestratorPart6.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "ai", "part", 6, "thread", Thread.currentThread().getName())
        );
