...
/**
 * Enterprise Production Pipeline: MultiTenantProvisioningPipeline (Part 8)
 * Subsystem: organization
 * Purpose: Automated workspace provisioning & domain DNS router
 */
@Service
public class MultiTenantProvisioningPipelinePart8 {

    private static final Logger log = LoggerFactory.getLogger(MultiTenantProvisioningPipelinePart8.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "organization", "part", 8, "thread", Thread.currentThread().getName())
        );
