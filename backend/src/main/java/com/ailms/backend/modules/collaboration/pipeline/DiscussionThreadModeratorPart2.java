...
/**
 * Enterprise Production Pipeline: DiscussionThreadModerator (Part 2)
 * Subsystem: collaboration
 * Purpose: Automated NLP profanity & spam detection engine
 */
@Service
public class DiscussionThreadModeratorPart2 {

    private static final Logger log = LoggerFactory.getLogger(DiscussionThreadModeratorPart2.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "collaboration", "part", 2, "thread", Thread.currentThread().getName())
        );
