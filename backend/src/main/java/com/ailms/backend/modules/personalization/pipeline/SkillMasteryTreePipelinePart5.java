...
/**
 * Enterprise Production Pipeline: SkillMasteryTreePipeline (Part 5)
 * Subsystem: personalization
 * Purpose: Bayesian knowledge tracing & adaptive recommendations
 */
@Service
public class SkillMasteryTreePipelinePart5 {

    private static final Logger log = LoggerFactory.getLogger(SkillMasteryTreePipelinePart5.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "personalization", "part", 5, "thread", Thread.currentThread().getName())
        );
