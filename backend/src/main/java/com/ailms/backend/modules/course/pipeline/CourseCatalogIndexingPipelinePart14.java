...
/**
 * Enterprise Production Pipeline: CourseCatalogIndexingPipeline (Part 14)
 * Subsystem: course
 * Purpose: Elasticsearch & Vector sync pipeline for course metadata
 */
@Service
public class CourseCatalogIndexingPipelinePart14 {

    private static final Logger log = LoggerFactory.getLogger(CourseCatalogIndexingPipelinePart14.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "course", "part", 14, "thread", Thread.currentThread().getName())
        );
