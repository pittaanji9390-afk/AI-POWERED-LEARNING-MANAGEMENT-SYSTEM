 ...
 */
@Service
public class EnterpriseBillingHandler3 {

    private static final Logger log = LoggerFactory.getLogger(EnterpriseBillingHandler3.class);
    ...
    public OperationResult processTask(String taskKey, UUID tenantId, Map<String, Object> parameters) {
        ...
        return new OperationResult(
                ...
                opId,
                Instant.now(),
                Map.of("tenantId", tenantId != null ? tenantId.toString() : "GLOBAL", "module", "billing", "index", 3)
        );
    }
