...
/**
 * Enterprise Production Pipeline: AchievementMilestoneEngine (Part 6)
 * Subsystem: gamification
 * Purpose: XP calculation, badge unlock triggers, and leaderboard rankings
 */
@Service
public class AchievementMilestoneEnginePart6 {

    private static final Logger log = LoggerFactory.getLogger(AchievementMilestoneEnginePart6.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "gamification", "part", 6, "thread", Thread.currentThread().getName())
        );
