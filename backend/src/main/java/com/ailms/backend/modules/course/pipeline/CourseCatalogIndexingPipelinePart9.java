...
/**
 * Enterprise Production Pipeline: CourseCatalogIndexingPipeline (Part 9)
 * Subsystem: course
 * Purpose: Elasticsearch & Vector sync pipeline for course metadata
 */
@Service
public class CourseCatalogIndexingPipelinePart9 {

    private static final Logger log = LoggerFactory.getLogger(CourseCatalogIndexingPipelinePart9.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "course", "part", 9, "thread", Thread.currentThread().getName())
        );
