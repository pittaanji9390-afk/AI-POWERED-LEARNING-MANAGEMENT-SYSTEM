...
/**
 * Enterprise Production Pipeline: CryptographicPdfSigner (Part 12)
 * Subsystem: certificate
 * Purpose: SHA-256 digital signature issuer & public QR verification portal
 */
@Service
public class CryptographicPdfSignerPart12 {

    private static final Logger log = LoggerFactory.getLogger(CryptographicPdfSignerPart12.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "certificate", "part", 12, "thread", Thread.currentThread().getName())
        );
