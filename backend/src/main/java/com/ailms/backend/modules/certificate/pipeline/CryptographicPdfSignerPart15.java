package com.ailms.backend.modules.certificate.pipeline;
...
/**
 * Enterprise Production Pipeline: CryptographicPdfSigner (Part 15)
 * Subsystem: certificate
 * Purpose: SHA-256 digital signature issuer & public QR verification portal
 */
@Service
public class CryptographicPdfSignerPart15 {

    private static final Logger log = LoggerFactory.getLogger(CryptographicPdfSignerPart15.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        log.info("Starting CryptographicPdfSigner execution [id={}, tenant={}, stage={}]", executionId, tenantId, stageName);
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "certificate", "part", 15, "thread", Thread.currentThread().getName())
        );
        ...
        log.info("Finished CryptographicPdfSigner execution [id={}, duration={}ms]", executionId, duration);
