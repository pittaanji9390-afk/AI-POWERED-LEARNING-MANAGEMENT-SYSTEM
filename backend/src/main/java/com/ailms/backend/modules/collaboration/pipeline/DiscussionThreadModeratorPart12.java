...
/**
 * Enterprise Production Pipeline: DiscussionThreadModerator (Part 12)
 * Subsystem: collaboration
 * Purpose: Automated NLP profanity & spam detection engine
 */
@Service
public class DiscussionThreadModeratorPart12 {

    private static final Logger log = LoggerFactory.getLogger(DiscussionThreadModeratorPart12.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "collaboration", "part", 12, "thread", Thread.currentThread().getName())
        );
