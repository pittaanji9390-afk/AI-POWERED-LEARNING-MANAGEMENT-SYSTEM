...
/**
 * Enterprise Production Pipeline: SocraticPromptOrchestrator (Part 15)
 * Subsystem: ai
 * Purpose: Boundary sandboxed RAG retrieval & anti-injection verifier
 */
@Service
public class SocraticPromptOrchestratorPart15 {

    private static final Logger log = LoggerFactory.getLogger(SocraticPromptOrchestratorPart15.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "ai", "part", 15, "thread", Thread.currentThread().getName())
        );
