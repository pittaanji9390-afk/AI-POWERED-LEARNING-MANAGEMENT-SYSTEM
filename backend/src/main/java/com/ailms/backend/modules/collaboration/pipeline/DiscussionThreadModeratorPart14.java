...
/**
 * Enterprise Production Pipeline: DiscussionThreadModerator (Part 14)
 * Subsystem: collaboration
 * Purpose: Automated NLP profanity & spam detection engine
 */
@Service
public class DiscussionThreadModeratorPart14 {

    private static final Logger log = LoggerFactory.getLogger(DiscussionThreadModeratorPart14.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "collaboration", "part", 14, "thread", Thread.currentThread().getName())
        );
