...
/**
 * Enterprise Production Pipeline: SocraticPromptOrchestrator (Part 9)
 * Subsystem: ai
 * Purpose: Boundary sandboxed RAG retrieval & anti-injection verifier
 */
@Service
public class SocraticPromptOrchestratorPart9 {

    private static final Logger log = LoggerFactory.getLogger(SocraticPromptOrchestratorPart9.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "ai", "part", 9, "thread", Thread.currentThread().getName())
        );
