...
/**
 * Enterprise Production Pipeline: SocraticPromptOrchestrator (Part 14)
 * Subsystem: ai
 * Purpose: Boundary sandboxed RAG retrieval & anti-injection verifier
 */
@Service
public class SocraticPromptOrchestratorPart14 {

    private static final Logger log = LoggerFactory.getLogger(SocraticPromptOrchestratorPart14.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "ai", "part", 14, "thread", Thread.currentThread().getName())
        );
