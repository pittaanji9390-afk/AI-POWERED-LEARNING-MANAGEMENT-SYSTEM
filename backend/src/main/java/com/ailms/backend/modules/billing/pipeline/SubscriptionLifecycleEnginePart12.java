...
/**
 * Enterprise Production Pipeline: SubscriptionLifecycleEngine (Part 12)
 * Subsystem: billing
 * Purpose: Multi-tenant recurring invoice & dunning orchestrator
 */
@Service
public class SubscriptionLifecycleEnginePart12 {

    private static final Logger log = LoggerFactory.getLogger(SubscriptionLifecycleEnginePart12.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "billing", "part", 12, "thread", Thread.currentThread().getName())
        );
