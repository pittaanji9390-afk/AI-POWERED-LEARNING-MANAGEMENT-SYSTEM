...
/**
 * Enterprise Production Pipeline: MultiTenantProvisioningPipeline (Part 2)
 * Subsystem: organization
 * Purpose: Automated workspace provisioning & domain DNS router
 */
@Service
public class MultiTenantProvisioningPipelinePart2 {

    private static final Logger log = LoggerFactory.getLogger(MultiTenantProvisioningPipelinePart2.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "organization", "part", 2, "thread", Thread.currentThread().getName())
        );
