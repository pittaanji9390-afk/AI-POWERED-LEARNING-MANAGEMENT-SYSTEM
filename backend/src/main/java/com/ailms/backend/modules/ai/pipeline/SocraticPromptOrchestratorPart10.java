...
/**
 * Enterprise Production Pipeline: SocraticPromptOrchestrator (Part 10)
 * Subsystem: ai
 * Purpose: Boundary sandboxed RAG retrieval & anti-injection verifier
 */
@Service
public class SocraticPromptOrchestratorPart10 {

    private static final Logger log = LoggerFactory.getLogger(SocraticPromptOrchestratorPart10.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "ai", "part", 10, "thread", Thread.currentThread().getName())
        );
