...
/**
 * Enterprise Production Pipeline: AdaptiveStreamTranscoder (Part 13)
 * Subsystem: media
 * Purpose: HLS multi-bitrate video transcoding & CDN pre-signed URL manager
 */
@Service
public class AdaptiveStreamTranscoderPart13 {

    private static final Logger log = LoggerFactory.getLogger(AdaptiveStreamTranscoderPart13.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "media", "part", 13, "thread", Thread.currentThread().getName())
        );
