 ...
 */
@Service
public class EnterpriseTelemetryHandler6 {

    private static final Logger log = LoggerFactory.getLogger(EnterpriseTelemetryHandler6.class);
    ...
    public OperationResult processTask(String taskKey, UUID tenantId, Map<String, Object> parameters) {
        ...
        return new OperationResult(
                ...
                opId,
                Instant.now(),
                Map.of("tenantId", tenantId != null ? tenantId.toString() : "GLOBAL", "module", "telemetry", "index", 6)
        );
    }
