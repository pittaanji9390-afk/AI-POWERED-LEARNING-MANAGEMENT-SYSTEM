...
/**
 * Enterprise Production Pipeline: AchievementMilestoneEngine (Part 11)
 * Subsystem: gamification
 * Purpose: XP calculation, badge unlock triggers, and leaderboard rankings
 */
@Service
public class AchievementMilestoneEnginePart11 {

    private static final Logger log = LoggerFactory.getLogger(AchievementMilestoneEnginePart11.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "gamification", "part", 11, "thread", Thread.currentThread().getName())
        );
