...
/**
 * Enterprise Production Pipeline: CryptographicPdfSigner (Part 7)
 * Subsystem: certificate
 * Purpose: SHA-256 digital signature issuer & public QR verification portal
 */
@Service
public class CryptographicPdfSignerPart7 {

    private static final Logger log = LoggerFactory.getLogger(CryptographicPdfSignerPart7.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "certificate", "part", 7, "thread", Thread.currentThread().getName())
        );
