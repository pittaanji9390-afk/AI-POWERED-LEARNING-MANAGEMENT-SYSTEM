...
/**
 * Enterprise Production Pipeline: SkillMasteryTreePipeline (Part 10)
 * Subsystem: personalization
 * Purpose: Bayesian knowledge tracing & adaptive recommendations
 */
@Service
public class SkillMasteryTreePipelinePart10 {

    private static final Logger log = LoggerFactory.getLogger(SkillMasteryTreePipelinePart10.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "personalization", "part", 10, "thread", Thread.currentThread().getName())
        );
