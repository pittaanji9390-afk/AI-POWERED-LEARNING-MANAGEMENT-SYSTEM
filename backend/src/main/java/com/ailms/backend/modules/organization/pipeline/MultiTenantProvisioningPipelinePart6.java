...
/**
 * Enterprise Production Pipeline: MultiTenantProvisioningPipeline (Part 6)
 * Subsystem: organization
 * Purpose: Automated workspace provisioning & domain DNS router
 */
@Service
public class MultiTenantProvisioningPipelinePart6 {

    private static final Logger log = LoggerFactory.getLogger(MultiTenantProvisioningPipelinePart6.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "organization", "part", 6, "thread", Thread.currentThread().getName())
        );
