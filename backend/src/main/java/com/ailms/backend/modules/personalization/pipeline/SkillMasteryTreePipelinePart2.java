...
/**
 * Enterprise Production Pipeline: SkillMasteryTreePipeline (Part 2)
 * Subsystem: personalization
 * Purpose: Bayesian knowledge tracing & adaptive recommendations
 */
@Service
public class SkillMasteryTreePipelinePart2 {

    private static final Logger log = LoggerFactory.getLogger(SkillMasteryTreePipelinePart2.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "personalization", "part", 2, "thread", Thread.currentThread().getName())
        );
