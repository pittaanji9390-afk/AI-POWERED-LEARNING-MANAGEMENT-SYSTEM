...
/**
 * Enterprise Production Pipeline: SkillMasteryTreePipeline (Part 3)
 * Subsystem: personalization
 * Purpose: Bayesian knowledge tracing & adaptive recommendations
 */
@Service
public class SkillMasteryTreePipelinePart3 {

    private static final Logger log = LoggerFactory.getLogger(SkillMasteryTreePipelinePart3.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "personalization", "part", 3, "thread", Thread.currentThread().getName())
        );
