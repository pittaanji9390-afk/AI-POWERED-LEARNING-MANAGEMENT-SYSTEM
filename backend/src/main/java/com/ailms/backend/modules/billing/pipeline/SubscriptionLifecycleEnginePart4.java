...
/**
 * Enterprise Production Pipeline: SubscriptionLifecycleEngine (Part 4)
 * Subsystem: billing
 * Purpose: Multi-tenant recurring invoice & dunning orchestrator
 */
@Service
public class SubscriptionLifecycleEnginePart4 {

    private static final Logger log = LoggerFactory.getLogger(SubscriptionLifecycleEnginePart4.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "billing", "part", 4, "thread", Thread.currentThread().getName())
        );
