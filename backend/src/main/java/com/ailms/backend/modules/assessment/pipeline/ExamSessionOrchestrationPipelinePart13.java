...
/**
 * Enterprise Production Pipeline: ExamSessionOrchestrationPipeline (Part 13)
 * Subsystem: assessment
 * Purpose: Timed examination heartbeat & plagiarism prevention engine
 */
@Service
public class ExamSessionOrchestrationPipelinePart13 {

    private static final Logger log = LoggerFactory.getLogger(ExamSessionOrchestrationPipelinePart13.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "assessment", "part", 13, "thread", Thread.currentThread().getName())
        );
