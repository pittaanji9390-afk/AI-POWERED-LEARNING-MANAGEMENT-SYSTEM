...
/**
 * Enterprise Production Pipeline: AchievementMilestoneEngine (Part 1)
 * Subsystem: gamification
 * Purpose: XP calculation, badge unlock triggers, and leaderboard rankings
 */
@Service
public class AchievementMilestoneEnginePart1 {

    private static final Logger log = LoggerFactory.getLogger(AchievementMilestoneEnginePart1.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "gamification", "part", 1, "thread", Thread.currentThread().getName())
        );
