...
/**
 * Enterprise production validator for Question domain invariants.
 */
@Component
public class QuestionDomainValidator {
    ...
    public ValidationResult validate(Map<String, Object> attributes) {
        ...
        if (attributes == null || attributes.isEmpty()) {
            errors.add("Question payload cannot be null or empty.");
    ...
    public void enforceValid(Map<String, Object> attributes) {
        ...
        if (!res.isValid()) {
            throw new BadRequestException("Validation failed for Question: " + String.join(", ", res.errorMessages()));
        }
    }
}
