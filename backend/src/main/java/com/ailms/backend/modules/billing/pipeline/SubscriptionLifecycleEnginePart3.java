...
/**
 * Enterprise Production Pipeline: SubscriptionLifecycleEngine (Part 3)
 * Subsystem: billing
 * Purpose: Multi-tenant recurring invoice & dunning orchestrator
 */
@Service
public class SubscriptionLifecycleEnginePart3 {

    private static final Logger log = LoggerFactory.getLogger(SubscriptionLifecycleEnginePart3.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "billing", "part", 3, "thread", Thread.currentThread().getName())
        );
