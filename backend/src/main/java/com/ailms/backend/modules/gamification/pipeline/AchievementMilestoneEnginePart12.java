...
/**
 * Enterprise Production Pipeline: AchievementMilestoneEngine (Part 12)
 * Subsystem: gamification
 * Purpose: XP calculation, badge unlock triggers, and leaderboard rankings
 */
@Service
public class AchievementMilestoneEnginePart12 {

    private static final Logger log = LoggerFactory.getLogger(AchievementMilestoneEnginePart12.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "gamification", "part", 12, "thread", Thread.currentThread().getName())
        );
