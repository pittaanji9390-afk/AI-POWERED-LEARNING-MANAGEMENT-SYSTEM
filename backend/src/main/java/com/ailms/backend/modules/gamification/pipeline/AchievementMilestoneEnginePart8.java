...
/**
 * Enterprise Production Pipeline: AchievementMilestoneEngine (Part 8)
 * Subsystem: gamification
 * Purpose: XP calculation, badge unlock triggers, and leaderboard rankings
 */
@Service
public class AchievementMilestoneEnginePart8 {

    private static final Logger log = LoggerFactory.getLogger(AchievementMilestoneEnginePart8.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "gamification", "part", 8, "thread", Thread.currentThread().getName())
        );
