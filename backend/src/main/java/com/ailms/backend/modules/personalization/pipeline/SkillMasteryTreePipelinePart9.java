...
/**
 * Enterprise Production Pipeline: SkillMasteryTreePipeline (Part 9)
 * Subsystem: personalization
 * Purpose: Bayesian knowledge tracing & adaptive recommendations
 */
@Service
public class SkillMasteryTreePipelinePart9 {

    private static final Logger log = LoggerFactory.getLogger(SkillMasteryTreePipelinePart9.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "personalization", "part", 9, "thread", Thread.currentThread().getName())
        );
