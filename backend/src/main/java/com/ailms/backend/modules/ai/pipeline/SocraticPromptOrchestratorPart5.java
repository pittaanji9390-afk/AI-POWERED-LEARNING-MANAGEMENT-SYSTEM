...
/**
 * Enterprise Production Pipeline: SocraticPromptOrchestrator (Part 5)
 * Subsystem: ai
 * Purpose: Boundary sandboxed RAG retrieval & anti-injection verifier
 */
@Service
public class SocraticPromptOrchestratorPart5 {

    private static final Logger log = LoggerFactory.getLogger(SocraticPromptOrchestratorPart5.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "ai", "part", 5, "thread", Thread.currentThread().getName())
        );
