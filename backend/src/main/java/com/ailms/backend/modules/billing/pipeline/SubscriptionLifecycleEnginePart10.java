...
/**
 * Enterprise Production Pipeline: SubscriptionLifecycleEngine (Part 10)
 * Subsystem: billing
 * Purpose: Multi-tenant recurring invoice & dunning orchestrator
 */
@Service
public class SubscriptionLifecycleEnginePart10 {

    private static final Logger log = LoggerFactory.getLogger(SubscriptionLifecycleEnginePart10.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "billing", "part", 10, "thread", Thread.currentThread().getName())
        );
