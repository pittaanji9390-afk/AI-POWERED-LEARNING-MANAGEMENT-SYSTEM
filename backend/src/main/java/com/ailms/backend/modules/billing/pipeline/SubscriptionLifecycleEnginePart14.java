...
/**
 * Enterprise Production Pipeline: SubscriptionLifecycleEngine (Part 14)
 * Subsystem: billing
 * Purpose: Multi-tenant recurring invoice & dunning orchestrator
 */
@Service
public class SubscriptionLifecycleEnginePart14 {

    private static final Logger log = LoggerFactory.getLogger(SubscriptionLifecycleEnginePart14.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "billing", "part", 14, "thread", Thread.currentThread().getName())
        );
