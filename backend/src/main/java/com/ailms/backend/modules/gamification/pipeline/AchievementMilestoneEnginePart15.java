...
/**
 * Enterprise Production Pipeline: AchievementMilestoneEngine (Part 15)
 * Subsystem: gamification
 * Purpose: XP calculation, badge unlock triggers, and leaderboard rankings
 */
@Service
public class AchievementMilestoneEnginePart15 {

    private static final Logger log = LoggerFactory.getLogger(AchievementMilestoneEnginePart15.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "gamification", "part", 15, "thread", Thread.currentThread().getName())
        );
