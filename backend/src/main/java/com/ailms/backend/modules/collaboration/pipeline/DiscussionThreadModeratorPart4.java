...
/**
 * Enterprise Production Pipeline: DiscussionThreadModerator (Part 4)
 * Subsystem: collaboration
 * Purpose: Automated NLP profanity & spam detection engine
 */
@Service
public class DiscussionThreadModeratorPart4 {

    private static final Logger log = LoggerFactory.getLogger(DiscussionThreadModeratorPart4.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "collaboration", "part", 4, "thread", Thread.currentThread().getName())
        );
