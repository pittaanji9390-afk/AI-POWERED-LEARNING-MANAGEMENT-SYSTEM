...
/**
 * Enterprise Production Pipeline: SkillMasteryTreePipeline (Part 4)
 * Subsystem: personalization
 * Purpose: Bayesian knowledge tracing & adaptive recommendations
 */
@Service
public class SkillMasteryTreePipelinePart4 {

    private static final Logger log = LoggerFactory.getLogger(SkillMasteryTreePipelinePart4.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "personalization", "part", 4, "thread", Thread.currentThread().getName())
        );
