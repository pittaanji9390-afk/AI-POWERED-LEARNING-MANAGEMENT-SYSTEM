...
/**
 * Enterprise Production Pipeline: DiscussionThreadModerator (Part 3)
 * Subsystem: collaboration
 * Purpose: Automated NLP profanity & spam detection engine
 */
@Service
public class DiscussionThreadModeratorPart3 {

    private static final Logger log = LoggerFactory.getLogger(DiscussionThreadModeratorPart3.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "collaboration", "part", 3, "thread", Thread.currentThread().getName())
        );
