...
/**
 * Enterprise Production Pipeline: MultiTenantProvisioningPipeline (Part 3)
 * Subsystem: organization
 * Purpose: Automated workspace provisioning & domain DNS router
 */
@Service
public class MultiTenantProvisioningPipelinePart3 {

    private static final Logger log = LoggerFactory.getLogger(MultiTenantProvisioningPipelinePart3.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "organization", "part", 3, "thread", Thread.currentThread().getName())
        );
