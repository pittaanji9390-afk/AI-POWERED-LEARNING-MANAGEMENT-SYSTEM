...
/**
 * Enterprise Production Pipeline: CryptographicPdfSigner (Part 2)
 * Subsystem: certificate
 * Purpose: SHA-256 digital signature issuer & public QR verification portal
 */
@Service
public class CryptographicPdfSignerPart2 {

    private static final Logger log = LoggerFactory.getLogger(CryptographicPdfSignerPart2.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "certificate", "part", 2, "thread", Thread.currentThread().getName())
        );
