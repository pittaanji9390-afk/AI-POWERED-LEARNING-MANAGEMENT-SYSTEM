...
/**
 * Enterprise Production Pipeline: LearningTelemetryAggregator (Part 2)
 * Subsystem: analytics
 * Purpose: Time-series event processor & engagement analytics
 */
@Service
public class LearningTelemetryAggregatorPart2 {

    private static final Logger log = LoggerFactory.getLogger(LearningTelemetryAggregatorPart2.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "analytics", "part", 2, "thread", Thread.currentThread().getName())
        );
