...
/**
 * Enterprise Production Pipeline: CryptographicPdfSigner (Part 10)
 * Subsystem: certificate
 * Purpose: SHA-256 digital signature issuer & public QR verification portal
 */
@Service
public class CryptographicPdfSignerPart10 {

    private static final Logger log = LoggerFactory.getLogger(CryptographicPdfSignerPart10.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "certificate", "part", 10, "thread", Thread.currentThread().getName())
        );
