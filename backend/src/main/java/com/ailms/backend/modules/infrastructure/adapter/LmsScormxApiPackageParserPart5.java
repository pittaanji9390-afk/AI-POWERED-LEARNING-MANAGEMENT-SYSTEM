...
/**
 * Enterprise Production Adapter: LmsScormxApiPackageParser (Part 5)
 * Purpose: SCORM 1.2, SCORM 2004, and xAPI (Tin Can) package parser and state tracker
 */
@Component
public class LmsScormxApiPackageParserPart5 {

    private static final Logger log = LoggerFactory.getLogger(LmsScormxApiPackageParserPart5.class);
    ...
    public AdapterResponse processRequest(String requestId, UUID organizationId, Map<String, Object> data) {
        log.info("Adapter LmsScormxApiPackageParserPart5 handling request [id={}, org={}]", requestId, organizationId);
