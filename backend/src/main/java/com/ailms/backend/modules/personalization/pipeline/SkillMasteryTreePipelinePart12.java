...
/**
 * Enterprise Production Pipeline: SkillMasteryTreePipeline (Part 12)
 * Subsystem: personalization
 * Purpose: Bayesian knowledge tracing & adaptive recommendations
 */
@Service
public class SkillMasteryTreePipelinePart12 {

    private static final Logger log = LoggerFactory.getLogger(SkillMasteryTreePipelinePart12.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "personalization", "part", 12, "thread", Thread.currentThread().getName())
        );
