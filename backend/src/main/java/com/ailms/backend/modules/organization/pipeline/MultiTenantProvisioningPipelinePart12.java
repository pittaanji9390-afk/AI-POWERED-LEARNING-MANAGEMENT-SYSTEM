...
/**
 * Enterprise Production Pipeline: MultiTenantProvisioningPipeline (Part 12)
 * Subsystem: organization
 * Purpose: Automated workspace provisioning & domain DNS router
 */
@Service
public class MultiTenantProvisioningPipelinePart12 {

    private static final Logger log = LoggerFactory.getLogger(MultiTenantProvisioningPipelinePart12.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "organization", "part", 12, "thread", Thread.currentThread().getName())
        );
