...
/**
 * Enterprise Production Pipeline: AdaptiveStreamTranscoder (Part 2)
 * Subsystem: media
 * Purpose: HLS multi-bitrate video transcoding & CDN pre-signed URL manager
 */
@Service
public class AdaptiveStreamTranscoderPart2 {

    private static final Logger log = LoggerFactory.getLogger(AdaptiveStreamTranscoderPart2.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "media", "part", 2, "thread", Thread.currentThread().getName())
        );
