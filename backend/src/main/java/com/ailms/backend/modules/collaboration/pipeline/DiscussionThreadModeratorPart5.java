...
/**
 * Enterprise Production Pipeline: DiscussionThreadModerator (Part 5)
 * Subsystem: collaboration
 * Purpose: Automated NLP profanity & spam detection engine
 */
@Service
public class DiscussionThreadModeratorPart5 {

    private static final Logger log = LoggerFactory.getLogger(DiscussionThreadModeratorPart5.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "collaboration", "part", 5, "thread", Thread.currentThread().getName())
        );
