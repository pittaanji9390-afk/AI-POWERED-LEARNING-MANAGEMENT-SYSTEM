...
/**
 * Enterprise Production Pipeline: SocraticPromptOrchestrator (Part 8)
 * Subsystem: ai
 * Purpose: Boundary sandboxed RAG retrieval & anti-injection verifier
 */
@Service
public class SocraticPromptOrchestratorPart8 {

    private static final Logger log = LoggerFactory.getLogger(SocraticPromptOrchestratorPart8.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "ai", "part", 8, "thread", Thread.currentThread().getName())
        );
