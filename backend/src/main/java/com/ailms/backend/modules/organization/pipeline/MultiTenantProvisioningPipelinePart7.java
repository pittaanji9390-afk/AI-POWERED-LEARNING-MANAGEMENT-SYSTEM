...
/**
 * Enterprise Production Pipeline: MultiTenantProvisioningPipeline (Part 7)
 * Subsystem: organization
 * Purpose: Automated workspace provisioning & domain DNS router
 */
@Service
public class MultiTenantProvisioningPipelinePart7 {

    private static final Logger log = LoggerFactory.getLogger(MultiTenantProvisioningPipelinePart7.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "organization", "part", 7, "thread", Thread.currentThread().getName())
        );
