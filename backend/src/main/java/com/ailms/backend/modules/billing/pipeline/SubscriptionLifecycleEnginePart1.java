...
/**
 * Enterprise Production Pipeline: SubscriptionLifecycleEngine (Part 1)
 * Subsystem: billing
 * Purpose: Multi-tenant recurring invoice & dunning orchestrator
 */
@Service
public class SubscriptionLifecycleEnginePart1 {

    private static final Logger log = LoggerFactory.getLogger(SubscriptionLifecycleEnginePart1.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "billing", "part", 1, "thread", Thread.currentThread().getName())
        );
