...
/**
 * Enterprise production validator for Assignment domain invariants.
 */
@Component
public class AssignmentDomainValidator {
    ...
    public ValidationResult validate(Map<String, Object> attributes) {
        ...
        if (attributes == null || attributes.isEmpty()) {
            errors.add("Assignment payload cannot be null or empty.");
    ...
    public void enforceValid(Map<String, Object> attributes) {
        ...
        if (!res.isValid()) {
            throw new BadRequestException("Validation failed for Assignment: " + String.join(", ", res.errorMessages()));
        }
    }
}
