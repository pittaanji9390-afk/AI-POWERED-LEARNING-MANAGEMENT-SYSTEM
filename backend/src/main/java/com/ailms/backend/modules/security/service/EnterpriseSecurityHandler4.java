 ...
 */
@Service
public class EnterpriseSecurityHandler4 {

    private static final Logger log = LoggerFactory.getLogger(EnterpriseSecurityHandler4.class);
    ...
    public OperationResult processTask(String taskKey, UUID tenantId, Map<String, Object> parameters) {
        ...
        return new OperationResult(
                ...
                opId,
                Instant.now(),
                Map.of("tenantId", tenantId != null ? tenantId.toString() : "GLOBAL", "module", "security", "index", 4)
        );
    }
