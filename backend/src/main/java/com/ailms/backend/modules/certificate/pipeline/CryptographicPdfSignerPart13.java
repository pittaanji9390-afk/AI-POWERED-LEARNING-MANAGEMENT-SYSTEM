...
/**
 * Enterprise Production Pipeline: CryptographicPdfSigner (Part 13)
 * Subsystem: certificate
 * Purpose: SHA-256 digital signature issuer & public QR verification portal
 */
@Service
public class CryptographicPdfSignerPart13 {

    private static final Logger log = LoggerFactory.getLogger(CryptographicPdfSignerPart13.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "certificate", "part", 13, "thread", Thread.currentThread().getName())
        );
