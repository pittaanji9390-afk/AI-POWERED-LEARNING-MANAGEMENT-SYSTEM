...
/**
 * Enterprise Production Pipeline: SocraticPromptOrchestrator (Part 7)
 * Subsystem: ai
 * Purpose: Boundary sandboxed RAG retrieval & anti-injection verifier
 */
@Service
public class SocraticPromptOrchestratorPart7 {

    private static final Logger log = LoggerFactory.getLogger(SocraticPromptOrchestratorPart7.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "ai", "part", 7, "thread", Thread.currentThread().getName())
        );
