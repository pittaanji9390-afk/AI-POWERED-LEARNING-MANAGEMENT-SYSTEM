...
/**
 * Enterprise Production Pipeline: CryptographicPdfSigner (Part 3)
 * Subsystem: certificate
 * Purpose: SHA-256 digital signature issuer & public QR verification portal
 */
@Service
public class CryptographicPdfSignerPart3 {

    private static final Logger log = LoggerFactory.getLogger(CryptographicPdfSignerPart3.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "certificate", "part", 3, "thread", Thread.currentThread().getName())
        );
