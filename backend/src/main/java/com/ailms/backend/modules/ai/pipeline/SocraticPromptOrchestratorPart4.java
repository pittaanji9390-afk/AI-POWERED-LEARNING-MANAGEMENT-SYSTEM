...
/**
 * Enterprise Production Pipeline: SocraticPromptOrchestrator (Part 4)
 * Subsystem: ai
 * Purpose: Boundary sandboxed RAG retrieval & anti-injection verifier
 */
@Service
public class SocraticPromptOrchestratorPart4 {

    private static final Logger log = LoggerFactory.getLogger(SocraticPromptOrchestratorPart4.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "ai", "part", 4, "thread", Thread.currentThread().getName())
        );
