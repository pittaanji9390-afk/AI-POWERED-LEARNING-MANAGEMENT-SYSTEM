...
/**
 * Enterprise Production Pipeline: SocraticPromptOrchestrator (Part 2)
 * Subsystem: ai
 * Purpose: Boundary sandboxed RAG retrieval & anti-injection verifier
 */
@Service
public class SocraticPromptOrchestratorPart2 {

    private static final Logger log = LoggerFactory.getLogger(SocraticPromptOrchestratorPart2.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "ai", "part", 2, "thread", Thread.currentThread().getName())
        );
