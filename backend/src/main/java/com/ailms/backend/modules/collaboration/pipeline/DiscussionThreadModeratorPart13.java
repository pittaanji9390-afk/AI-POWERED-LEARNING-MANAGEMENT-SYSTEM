...
/**
 * Enterprise Production Pipeline: DiscussionThreadModerator (Part 13)
 * Subsystem: collaboration
 * Purpose: Automated NLP profanity & spam detection engine
 */
@Service
public class DiscussionThreadModeratorPart13 {

    private static final Logger log = LoggerFactory.getLogger(DiscussionThreadModeratorPart13.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "collaboration", "part", 13, "thread", Thread.currentThread().getName())
        );
