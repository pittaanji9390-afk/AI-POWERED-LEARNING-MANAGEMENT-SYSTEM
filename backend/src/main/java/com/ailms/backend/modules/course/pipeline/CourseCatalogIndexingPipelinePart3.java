...
/**
 * Enterprise Production Pipeline: CourseCatalogIndexingPipeline (Part 3)
 * Subsystem: course
 * Purpose: Elasticsearch & Vector sync pipeline for course metadata
 */
@Service
public class CourseCatalogIndexingPipelinePart3 {

    private static final Logger log = LoggerFactory.getLogger(CourseCatalogIndexingPipelinePart3.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "course", "part", 3, "thread", Thread.currentThread().getName())
        );
