...
/**
 * Enterprise Production Pipeline: AchievementMilestoneEngine (Part 9)
 * Subsystem: gamification
 * Purpose: XP calculation, badge unlock triggers, and leaderboard rankings
 */
@Service
public class AchievementMilestoneEnginePart9 {

    private static final Logger log = LoggerFactory.getLogger(AchievementMilestoneEnginePart9.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "gamification", "part", 9, "thread", Thread.currentThread().getName())
        );
