...
/**
 * Enterprise Production Pipeline: SubscriptionLifecycleEngine (Part 8)
 * Subsystem: billing
 * Purpose: Multi-tenant recurring invoice & dunning orchestrator
 */
@Service
public class SubscriptionLifecycleEnginePart8 {

    private static final Logger log = LoggerFactory.getLogger(SubscriptionLifecycleEnginePart8.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "billing", "part", 8, "thread", Thread.currentThread().getName())
        );
