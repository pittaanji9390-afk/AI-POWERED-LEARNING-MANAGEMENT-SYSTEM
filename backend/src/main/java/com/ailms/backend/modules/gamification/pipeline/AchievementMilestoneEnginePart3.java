...
/**
 * Enterprise Production Pipeline: AchievementMilestoneEngine (Part 3)
 * Subsystem: gamification
 * Purpose: XP calculation, badge unlock triggers, and leaderboard rankings
 */
@Service
public class AchievementMilestoneEnginePart3 {

    private static final Logger log = LoggerFactory.getLogger(AchievementMilestoneEnginePart3.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "gamification", "part", 3, "thread", Thread.currentThread().getName())
        );
