...
/**
 * Enterprise Production Pipeline: DiscussionThreadModerator (Part 11)
 * Subsystem: collaboration
 * Purpose: Automated NLP profanity & spam detection engine
 */
@Service
public class DiscussionThreadModeratorPart11 {

    private static final Logger log = LoggerFactory.getLogger(DiscussionThreadModeratorPart11.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "collaboration", "part", 11, "thread", Thread.currentThread().getName())
        );
