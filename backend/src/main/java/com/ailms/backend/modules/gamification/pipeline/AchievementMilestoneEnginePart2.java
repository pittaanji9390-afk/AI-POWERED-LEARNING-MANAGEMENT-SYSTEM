...
/**
 * Enterprise Production Pipeline: AchievementMilestoneEngine (Part 2)
 * Subsystem: gamification
 * Purpose: XP calculation, badge unlock triggers, and leaderboard rankings
 */
@Service
public class AchievementMilestoneEnginePart2 {

    private static final Logger log = LoggerFactory.getLogger(AchievementMilestoneEnginePart2.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "gamification", "part", 2, "thread", Thread.currentThread().getName())
        );
