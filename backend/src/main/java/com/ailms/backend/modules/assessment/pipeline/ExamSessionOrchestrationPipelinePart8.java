...
/**
 * Enterprise Production Pipeline: ExamSessionOrchestrationPipeline (Part 8)
 * Subsystem: assessment
 * Purpose: Timed examination heartbeat & plagiarism prevention engine
 */
@Service
public class ExamSessionOrchestrationPipelinePart8 {

    private static final Logger log = LoggerFactory.getLogger(ExamSessionOrchestrationPipelinePart8.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "assessment", "part", 8, "thread", Thread.currentThread().getName())
        );
