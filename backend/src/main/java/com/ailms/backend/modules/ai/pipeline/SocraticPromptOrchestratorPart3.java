...
/**
 * Enterprise Production Pipeline: SocraticPromptOrchestrator (Part 3)
 * Subsystem: ai
 * Purpose: Boundary sandboxed RAG retrieval & anti-injection verifier
 */
@Service
public class SocraticPromptOrchestratorPart3 {

    private static final Logger log = LoggerFactory.getLogger(SocraticPromptOrchestratorPart3.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "ai", "part", 3, "thread", Thread.currentThread().getName())
        );
