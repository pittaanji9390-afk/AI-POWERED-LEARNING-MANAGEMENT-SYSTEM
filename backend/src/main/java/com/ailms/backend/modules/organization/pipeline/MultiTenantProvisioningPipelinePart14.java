...
/**
 * Enterprise Production Pipeline: MultiTenantProvisioningPipeline (Part 14)
 * Subsystem: organization
 * Purpose: Automated workspace provisioning & domain DNS router
 */
@Service
public class MultiTenantProvisioningPipelinePart14 {

    private static final Logger log = LoggerFactory.getLogger(MultiTenantProvisioningPipelinePart14.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "organization", "part", 14, "thread", Thread.currentThread().getName())
        );
