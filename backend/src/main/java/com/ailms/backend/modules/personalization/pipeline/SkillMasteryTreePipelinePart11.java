...
/**
 * Enterprise Production Pipeline: SkillMasteryTreePipeline (Part 11)
 * Subsystem: personalization
 * Purpose: Bayesian knowledge tracing & adaptive recommendations
 */
@Service
public class SkillMasteryTreePipelinePart11 {

    private static final Logger log = LoggerFactory.getLogger(SkillMasteryTreePipelinePart11.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "personalization", "part", 11, "thread", Thread.currentThread().getName())
        );
