...
/**
 * Enterprise Production Pipeline: DiscussionThreadModerator (Part 8)
 * Subsystem: collaboration
 * Purpose: Automated NLP profanity & spam detection engine
 */
@Service
public class DiscussionThreadModeratorPart8 {

    private static final Logger log = LoggerFactory.getLogger(DiscussionThreadModeratorPart8.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "collaboration", "part", 8, "thread", Thread.currentThread().getName())
        );
