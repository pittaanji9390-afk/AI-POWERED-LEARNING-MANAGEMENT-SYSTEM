...
/**
 * Enterprise Production Pipeline: SubscriptionLifecycleEngine (Part 15)
 * Subsystem: billing
 * Purpose: Multi-tenant recurring invoice & dunning orchestrator
 */
@Service
public class SubscriptionLifecycleEnginePart15 {

    private static final Logger log = LoggerFactory.getLogger(SubscriptionLifecycleEnginePart15.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "billing", "part", 15, "thread", Thread.currentThread().getName())
        );
