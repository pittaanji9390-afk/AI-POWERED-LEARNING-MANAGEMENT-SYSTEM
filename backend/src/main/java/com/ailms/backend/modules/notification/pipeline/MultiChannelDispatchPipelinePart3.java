...
/**
 * Enterprise Production Pipeline: MultiChannelDispatchPipeline (Part 3)
 * Subsystem: notification
 * Purpose: Priority queue notification router (WebSocket, In-App, Email)
 */
@Service
public class MultiChannelDispatchPipelinePart3 {

    private static final Logger log = LoggerFactory.getLogger(MultiChannelDispatchPipelinePart3.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "notification", "part", 3, "thread", Thread.currentThread().getName())
        );
