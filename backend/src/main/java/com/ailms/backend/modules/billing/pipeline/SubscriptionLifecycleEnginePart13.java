...
/**
 * Enterprise Production Pipeline: SubscriptionLifecycleEngine (Part 13)
 * Subsystem: billing
 * Purpose: Multi-tenant recurring invoice & dunning orchestrator
 */
@Service
public class SubscriptionLifecycleEnginePart13 {

    private static final Logger log = LoggerFactory.getLogger(SubscriptionLifecycleEnginePart13.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "billing", "part", 13, "thread", Thread.currentThread().getName())
        );
