package com.ailms.backend.modules.course.pipeline;
...
/**
 * Enterprise Production Pipeline: CourseCatalogIndexingPipeline (Part 12)
 * Subsystem: course
 * Purpose: Elasticsearch & Vector sync pipeline for course metadata
 */
@Service
public class CourseCatalogIndexingPipelinePart12 {

    private static final Logger log = LoggerFactory.getLogger(CourseCatalogIndexingPipelinePart12.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        log.info("Starting CourseCatalogIndexingPipeline execution [id={}, tenant={}, stage={}]", executionId, tenantId, stageName);
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "course", "part", 12, "thread", Thread.currentThread().getName())
        );
        ...
        log.info("Finished CourseCatalogIndexingPipeline execution [id={}, duration={}ms]", executionId, duration);
