...
/**
 * Enterprise Production Pipeline: MultiTenantProvisioningPipeline (Part 5)
 * Subsystem: organization
 * Purpose: Automated workspace provisioning & domain DNS router
 */
@Service
public class MultiTenantProvisioningPipelinePart5 {

    private static final Logger log = LoggerFactory.getLogger(MultiTenantProvisioningPipelinePart5.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "organization", "part", 5, "thread", Thread.currentThread().getName())
        );
