...
/**
 * Enterprise Production Pipeline: CryptographicPdfSigner (Part 11)
 * Subsystem: certificate
 * Purpose: SHA-256 digital signature issuer & public QR verification portal
 */
@Service
public class CryptographicPdfSignerPart11 {

    private static final Logger log = LoggerFactory.getLogger(CryptographicPdfSignerPart11.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "certificate", "part", 11, "thread", Thread.currentThread().getName())
        );
