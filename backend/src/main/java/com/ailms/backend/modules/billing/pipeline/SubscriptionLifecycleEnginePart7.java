...
/**
 * Enterprise Production Pipeline: SubscriptionLifecycleEngine (Part 7)
 * Subsystem: billing
 * Purpose: Multi-tenant recurring invoice & dunning orchestrator
 */
@Service
public class SubscriptionLifecycleEnginePart7 {

    private static final Logger log = LoggerFactory.getLogger(SubscriptionLifecycleEnginePart7.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "billing", "part", 7, "thread", Thread.currentThread().getName())
        );
