...
/**
 * Enterprise Production Pipeline: AdaptiveStreamTranscoder (Part 8)
 * Subsystem: media
 * Purpose: HLS multi-bitrate video transcoding & CDN pre-signed URL manager
 */
@Service
public class AdaptiveStreamTranscoderPart8 {

    private static final Logger log = LoggerFactory.getLogger(AdaptiveStreamTranscoderPart8.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "media", "part", 8, "thread", Thread.currentThread().getName())
        );
