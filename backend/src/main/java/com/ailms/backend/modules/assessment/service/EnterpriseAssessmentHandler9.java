 ...
 */
@Service
public class EnterpriseAssessmentHandler9 {

    private static final Logger log = LoggerFactory.getLogger(EnterpriseAssessmentHandler9.class);
    ...
    public OperationResult processTask(String taskKey, UUID tenantId, Map<String, Object> parameters) {
        ...
        return new OperationResult(
                ...
                opId,
                Instant.now(),
                Map.of("tenantId", tenantId != null ? tenantId.toString() : "GLOBAL", "module", "assessment", "index", 9)
        );
    }
