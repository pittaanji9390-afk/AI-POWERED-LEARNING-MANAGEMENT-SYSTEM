...
/**
 * Enterprise Production Adapter: ElasticsearchCourseQueryBuilder (Part 2)
 * Purpose: Full-text search ranking and facet aggregation builder
 */
@Component
public class ElasticsearchCourseQueryBuilderPart2 {

    private static final Logger log = LoggerFactory.getLogger(ElasticsearchCourseQueryBuilderPart2.class);
    ...
    public AdapterResponse processRequest(String requestId, UUID organizationId, Map<String, Object> data) {
        log.info("Adapter ElasticsearchCourseQueryBuilderPart2 handling request [id={}, org={}]", requestId, organizationId);
