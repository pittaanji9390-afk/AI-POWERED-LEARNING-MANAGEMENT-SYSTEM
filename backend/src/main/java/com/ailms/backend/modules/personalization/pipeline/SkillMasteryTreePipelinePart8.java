...
/**
 * Enterprise Production Pipeline: SkillMasteryTreePipeline (Part 8)
 * Subsystem: personalization
 * Purpose: Bayesian knowledge tracing & adaptive recommendations
 */
@Service
public class SkillMasteryTreePipelinePart8 {

    private static final Logger log = LoggerFactory.getLogger(SkillMasteryTreePipelinePart8.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "personalization", "part", 8, "thread", Thread.currentThread().getName())
        );
