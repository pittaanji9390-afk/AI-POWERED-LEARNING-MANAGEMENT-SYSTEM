...
/**
 * Enterprise Production Pipeline: AchievementMilestoneEngine (Part 4)
 * Subsystem: gamification
 * Purpose: XP calculation, badge unlock triggers, and leaderboard rankings
 */
@Service
public class AchievementMilestoneEnginePart4 {

    private static final Logger log = LoggerFactory.getLogger(AchievementMilestoneEnginePart4.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "gamification", "part", 4, "thread", Thread.currentThread().getName())
        );
