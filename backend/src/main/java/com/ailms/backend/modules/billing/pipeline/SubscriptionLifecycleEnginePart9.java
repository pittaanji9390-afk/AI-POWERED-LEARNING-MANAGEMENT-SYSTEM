...
/**
 * Enterprise Production Pipeline: SubscriptionLifecycleEngine (Part 9)
 * Subsystem: billing
 * Purpose: Multi-tenant recurring invoice & dunning orchestrator
 */
@Service
public class SubscriptionLifecycleEnginePart9 {

    private static final Logger log = LoggerFactory.getLogger(SubscriptionLifecycleEnginePart9.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "billing", "part", 9, "thread", Thread.currentThread().getName())
        );
