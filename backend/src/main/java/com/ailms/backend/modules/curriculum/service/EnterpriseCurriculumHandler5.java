 ...
 */
@Service
public class EnterpriseCurriculumHandler5 {

    private static final Logger log = LoggerFactory.getLogger(EnterpriseCurriculumHandler5.class);
    ...
    public OperationResult processTask(String taskKey, UUID tenantId, Map<String, Object> parameters) {
        ...
        return new OperationResult(
                ...
                opId,
                Instant.now(),
                Map.of("tenantId", tenantId != null ? tenantId.toString() : "GLOBAL", "module", "curriculum", "index", 5)
        );
    }
