...
/**
 * Enterprise Production Pipeline: DiscussionThreadModerator (Part 6)
 * Subsystem: collaboration
 * Purpose: Automated NLP profanity & spam detection engine
 */
@Service
public class DiscussionThreadModeratorPart6 {

    private static final Logger log = LoggerFactory.getLogger(DiscussionThreadModeratorPart6.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "collaboration", "part", 6, "thread", Thread.currentThread().getName())
        );
