...
/**
 * Enterprise Production Pipeline: MultiTenantProvisioningPipeline (Part 15)
 * Subsystem: organization
 * Purpose: Automated workspace provisioning & domain DNS router
 */
@Service
public class MultiTenantProvisioningPipelinePart15 {

    private static final Logger log = LoggerFactory.getLogger(MultiTenantProvisioningPipelinePart15.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "organization", "part", 15, "thread", Thread.currentThread().getName())
        );
