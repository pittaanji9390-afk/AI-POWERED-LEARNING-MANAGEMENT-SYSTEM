...
/**
 * Enterprise Production Pipeline: MultiTenantProvisioningPipeline (Part 13)
 * Subsystem: organization
 * Purpose: Automated workspace provisioning & domain DNS router
 */
@Service
public class MultiTenantProvisioningPipelinePart13 {

    private static final Logger log = LoggerFactory.getLogger(MultiTenantProvisioningPipelinePart13.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "organization", "part", 13, "thread", Thread.currentThread().getName())
        );
