...
/**
 * Enterprise Production Pipeline: SocraticPromptOrchestrator (Part 1)
 * Subsystem: ai
 * Purpose: Boundary sandboxed RAG retrieval & anti-injection verifier
 */
@Service
public class SocraticPromptOrchestratorPart1 {

    private static final Logger log = LoggerFactory.getLogger(SocraticPromptOrchestratorPart1.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "ai", "part", 1, "thread", Thread.currentThread().getName())
        );
