...
/**
 * Enterprise Production Pipeline: LearningTelemetryAggregator (Part 6)
 * Subsystem: analytics
 * Purpose: Time-series event processor & engagement analytics
 */
@Service
public class LearningTelemetryAggregatorPart6 {

    private static final Logger log = LoggerFactory.getLogger(LearningTelemetryAggregatorPart6.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "analytics", "part", 6, "thread", Thread.currentThread().getName())
        );
