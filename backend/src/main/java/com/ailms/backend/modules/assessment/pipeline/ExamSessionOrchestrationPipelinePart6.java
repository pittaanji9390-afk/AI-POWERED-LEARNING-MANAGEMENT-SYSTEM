...
/**
 * Enterprise Production Pipeline: ExamSessionOrchestrationPipeline (Part 6)
 * Subsystem: assessment
 * Purpose: Timed examination heartbeat & plagiarism prevention engine
 */
@Service
public class ExamSessionOrchestrationPipelinePart6 {

    private static final Logger log = LoggerFactory.getLogger(ExamSessionOrchestrationPipelinePart6.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "assessment", "part", 6, "thread", Thread.currentThread().getName())
        );
