...
/**
 * Enterprise Production Pipeline: SkillMasteryTreePipeline (Part 15)
 * Subsystem: personalization
 * Purpose: Bayesian knowledge tracing & adaptive recommendations
 */
@Service
public class SkillMasteryTreePipelinePart15 {

    private static final Logger log = LoggerFactory.getLogger(SkillMasteryTreePipelinePart15.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "personalization", "part", 15, "thread", Thread.currentThread().getName())
        );
