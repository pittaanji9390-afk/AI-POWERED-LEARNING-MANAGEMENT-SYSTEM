...
/**
 * Enterprise Production Pipeline: SkillMasteryTreePipeline (Part 1)
 * Subsystem: personalization
 * Purpose: Bayesian knowledge tracing & adaptive recommendations
 */
@Service
public class SkillMasteryTreePipelinePart1 {

    private static final Logger log = LoggerFactory.getLogger(SkillMasteryTreePipelinePart1.class);
    ...
    public ExecutionOutcome executeStage(UUID tenantId, String stageName, Map<String, Object> inputData) {
        ...
        ExecutionContext context = new ExecutionContext(
                ...
                Map.of("subsystem", "personalization", "part", 1, "thread", Thread.currentThread().getName())
        );
